    ...
    <>
      {step === 'pay' && order && (
        <div className="flex flex-col items-center text-center">
          <p className="mb-4 max-w-[300px] text-[14px] leading-relaxed text-muted">
          ...
          >
            <span className="min-w-0 flex-1 truncate font-mono text-[13px] text-ink">{order.address}</span>
            ...
            {plans.map((p) => {
              ...
              return (
                <button
                  ...
                  className={
                    'flex items-center gap-3 rounded-3xl border bg-surface px-4 py-3 text-left transition-[transform,background-color,border-color] duration-150 active:scale-[0.99] ' +
                            ...
                            {usdts.map((u) => (
                              <button
                                ...
                                className={
                                  ...
                                  'flex h-11 w-full items-center gap-3 rounded-full px-3 text-left text-[15px] transition-colors ' +
                                  (asset === u.id
