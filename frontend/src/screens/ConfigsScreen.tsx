      ...
      <div className="px-4 pt-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center px-6 pt-[14vh] text-center">
            ...
            <h2 className="font-display mt-6 text-[22px] font-semibold leading-tight text-ink">
              {t('pay.pendingTitle')}
            </h2>
            <p className="mb-8 mt-2 max-w-[290px] text-[14px] leading-relaxed text-muted">
              {t('pay.pendingHint')}
            </p>
          ...
          <div className="animate-fade space-y-4">
              ...
              (expired ? (
                <div className="flex items-center gap-3 rounded-3xl border border-border bg-surface px-4 py-3">
                  <button onClick={onGoSubscription} className="tap min-w-0 flex-1 text-left active:opacity-70">
                    ...
                    <div className="mt-0.5 text-[13px] text-muted">{t('sub.expiredShort')}</div>
                  </button>
                ...
                <div className="flex items-center gap-3 rounded-3xl border border-border bg-surface px-4 py-3">
                  <button onClick={onGoSubscription} className="tap min-w-0 flex-1 text-left active:opacity-70">
                    ...
                    <div className="animate-rise mt-0.5 text-[13px] text-muted">
                      {t('sub.daysLeft', {
                        n: Math.max(
                          0,
            ...
            <div className="animate-scale-in grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="mt-1 text-[13px] text-muted">{t('home.devicesSub')}</div>
              </button>
              <button
              ...
              >
                ...
                <div className="mt-1 text-[13px] text-muted">{t('home.usageSub')}</div>
              </button>
            </div>
          </div>
        )}
