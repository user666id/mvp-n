...
// ── admin mock data ──
const adminProfiles = [
  { id: 804716840, internal_id: 1, username: 'user666id', first_name: 'mvp-n', is_active: true, is_blocked: false, is_admin: true, created_at: ago(43200), traffic_used: 42_949_672_960, devices_count: 4, configs_count: 1, paid_until: null, is_expired: false }, // key/lifetime
...
export async function mockRequest(
  ...
  if (path === '/plans')
    return {
      ...
      gram_usd: GRAM_USD,
      stars_by_days: { 7: 150, 30: 350, 90: 990, 365: 2900 },
    }

  if (path === '/stars/invoice' && m === 'POST') {
    const days = body?.plan_days || 30
    const stars = ({ 7: 150, 30: 350, 90: 990, 365: 2900 } as Record<number, number>)[days] ?? 350
