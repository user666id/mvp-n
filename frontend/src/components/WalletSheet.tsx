    ...
    <BottomSheet open={open} onClose={onClose}>
      ...
      {address ? (
        <div className="flex items-center gap-3 rounded-3xl border border-border bg-surface px-4 py-3">
          <button
            onClick={copy}
            className="tap flex min-w-0 flex-1 items-center gap-3 text-left active:opacity-70"
        ...
        <>
          <p className="mx-auto mb-6 max-w-[280px] text-center text-[14px] leading-snug text-muted">
