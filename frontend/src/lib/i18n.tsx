...
const dict = {
  ...
  'pay.withdrawalConsent': {
    en: 'I request access to start immediately and accept that I lose the 14-day right of withdrawal.',
    ru: 'Прошу начать предоставление доступа немедленно и подтверждаю, что теряю право на 14-дневный отказ.',
  },
  'pay.starsProcessing': {
