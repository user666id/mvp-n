...
/**
 * Beta UI variant — the redesign served at /beta/ (built with VITE_BETA=1) and
 * opened by the bot's "Test" button. Same functionality as prod, new navigation:
 * a bottom tab bar instead of the hamburger drawer. Prod (/v2/) is unaffected.
 */
export const IS_BETA = import.meta.env.VITE_BETA === '1'
