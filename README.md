...
- **One-tap connection** — pick a client and import the subscription via web-redirect; setup guides for iOS, Android, Windows, macOS, Linux, Apple TV and Android TV.
...
- **Owner console** — keys, profiles (block, devices, extend with an access key), traffic (total / today in MSK), domain statuses.
