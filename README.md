...
Код открыт для прозрачности. AGPL означает: можно изучать, изменять и
self-hosting'ить, но если вы запускаете изменённую версию как сетевой сервис —
обязаны опубликовать исходники своих изменений под той же лицензией.
